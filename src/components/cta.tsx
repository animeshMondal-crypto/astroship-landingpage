...
function Cta() {
  return (
    <div className="mb-10 flex flex-col gap-10 justify-center items-center">
      <h1 className="text-muted-foreground">Works with your technologies</h1>
      <div className="flex justify-center items-center lg:gap-10 gap-5">
        <svg
          viewBox="0 0 24 24"
          className="h-8 md:h-12"
          astro-icon="simple-icons:react"
        >
          <path
            fill="currentColor"
        ...
        <svg
          viewBox="0 0 24 24"
          className="h-8 md:h-12"
          astro-icon="simple-icons:svelte"
        >
          <path
            fill="currentColor"
        ...
        <svg
          ...
          astro-icon="simple-icons:alpinedotjs"
        >
          <path
            fill="currentColor"
        ...
        <svg
          viewBox="0 0 24 24"
          className="h-8 md:h-12"
          astro-icon="simple-icons:vercel"
        >
      ...
      <div className="bg-black rounded-md p-3 md:w-3/4 h-[300px] flex flex-col justify-center items-center text-center gap-5">
        ...
        <Link href="/" className="px-5 py-3 bg-white rounded-md">
          Get Started
        </Link>
      </div>
    </div>
